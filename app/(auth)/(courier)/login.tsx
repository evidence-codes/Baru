    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <VStack className="p-4 mb-4 w-full">
        ...
        <Text className="font-inter_regular text-[12px] text-[#979797] mt-4">
          Let us get you back to picking up and delivering
        </Text>
      </VStack>
      ...
      {/* <VStack className="p-4">
        <Text
          className="font-inter_regular text-[12px] text-[#2B63E1] mt-4"
          onPress={() => router.push("/(auth)/(courier)/signup")}
        >
          Sign up a courier account
        </Text>
      </VStack> */}
