...
import YellowBox from "@/assets/images/svg/big-yellow-box.svg";
import Message from "@/assets/images/svg/message.svg";
import Call from "@/assets/images/svg/call.svg";
import { useLocalSearchParams } from "expo-router";

interface SentDetailsProps {
  id: string;
  progress: number;
  from: string;
  to: string;
...
export default function SentDetailsScreen() {
  const params = useLocalSearchParams() as Partial<SentDetailsProps>;
  const {
    id,
    progress,
    from,
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FFF4E4] px-4">
      <StatusBar style="dark" backgroundColor="#FFF4E4" />
